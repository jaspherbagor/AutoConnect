      ...
      <section className="faq-section container-fluid px-md-4 px-sm-4 px-3 py-5">
        ...
        <div className="col-md-10 col-sm-10 col-12 align-items-center justify-content-centerm container-fluid">
          <div class="accordion" id="accordionPanelsStayOpenExample">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq-Eight" aria-expanded="true" aria-controls="faq-Eight">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq-Nine" aria-expanded="true" aria-controls="faq-Nine">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq-Ten" aria-expanded="true" aria-controls="faq-Ten">
