                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className="nav-link active fw-semibold me-3 text-black" aria-current="page" href="#"><i className="bi bi-house-door fs-5"></i> HOME</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link fw-semibold me-3 text-black" href="#"><i className="bi bi-info-circle fs-5"></i> ABOUT</a>
                            </li>
                            <li className="nav-item">
